...
import com.bitbyashish.car_rental.dto.AuthenticationResponse;
import com.bitbyashish.car_rental.dto.RegisterRequest;
import com.bitbyashish.car_rental.entity.User;
// import com.bitbyashish.car_rental.enums.Role; // Remove this import if not needed
import com.bitbyashish.car_rental.repository.UserRepository;
import com.bitbyashish.car_rental.security.jwt.JwtService;
...
public class AuthenticationService {
        ...
        public AuthenticationResponse register(RegisterRequest request) {
                var user = User.builder()
                                ...
                                .role(User.Role.CUSTOMER) // or User.Role.ADMIN
                                .build();
